"""
Django settings for dj_momo_payments project.
...
SECRET_KEY = 'django-insecure-!x#donj!tqf8qz#ohsrk2%41k8=2rbd_*r6ktc_61m-=#@be7h'
...
ROOT_URLCONF = 'dj_momo_payments.urls'
...
WSGI_APPLICATION = 'dj_momo_payments.wsgi.application'
